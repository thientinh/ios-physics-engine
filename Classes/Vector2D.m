...
-(Vector2D*)abs {
  // EFFECTS: Returns the magnitude of this Vector
...
- (Vector2D*) leftHandNormal {
  // EFFECTS: Returns a new vector that is rotated 90 degrees anti-clockwise from this vector
  return [Vector2D vectorWith:-self.y y:self.x];
}

- (Vector2D*) rightHandNormal {
  // EFFECTS: Returns a new vector that is rotated 90 degrees clockwise from this vector
  return [Vector2D vectorWith:self.y y:self.x];
}
